        ...
        <div className="container mx-auto mt-20 grid grid-cols-4 gap-4">
            <div className="bg-zinc-100 rounded-2xl overflow-hidden product-card relative">
                <div className="relative">
                    ...
                    <Link className="product-card-btn absolute bottom-2 left-0 right-0 text-center bg-black text-white rounded-3xl py-3 px-8 w-10/12 mx-auto" href="#">Add to Cart</Link>
                </div>
                <div className="p-6">
